return function()
	...
	cmp.setup({
		...
		sorting = {
			priority_weight = 2,
			comparators = vim.list_extend(require("core.settings").use_copilot and {
		...
		-- You can set mappings here if you want
		...
		sources = {
			...
			{ name = "latex_symbols" },
			{
				...
				option = {
					get_bufnrs = function()
						return vim.api.nvim_buf_line_count(0) < 15000 and { vim.api.nvim_get_current_buf() } or {}
					end,
				},
			},
			{ name = "copilot" },
