return function()
	...
	require("which-key").setup({
		...
		spec = {
			...
			{ "<leader>cB", desc = "cmake: Quick build" },
			{ "<leader>cc", desc = "cmake: Clean" },
			{ "<leader>cd", desc = "cmake: Debug" },
			{ "<leader>cD", desc = "cmake: Quick debug" },
			{ "<leader>cg", desc = "cmake: Generate" },
			{ "<leader>co", desc = "cmake: Open cache" },
			{ "<leader>cq", desc = "cmake: Close runner" },
			{ "<leader>cR", desc = "cmake: Quick run" },
			{ "<leader>cr", desc = "cmake: Run" },
			{ "<leader>cs", desc = "cmake: Select build type" },
			{ "<leader>cS", desc = "cmake: Quick start" },
			{ "<leader>ct", desc = "cmake: Run tests" },
			--- Debug
