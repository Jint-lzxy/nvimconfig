	...
	require("which-key").register({
		...
		["<leader>"] = {
			...
			d = {
				...
				R = "debug: Start a Lua debugger",
				t = "debug: Terminate the current session",
				v = "debug: Step over",
			},
			f = {
				name = " Telescope / Fuzzy Finder",
				a = "find: Nvim automatic commands",
				b = "find: Open buffer(s)",
				c = "ui: Change colorscheme",
				d = "find: Session",
				e = "find: File using ShaDa",
				f = "find: File under cwd",
				g = "find: File managed by git",
				h = "find: Nvim highlight groups",
				i = "find: Open a file browser",
				k = "find: Keymaps",
				n = "edit: New empty file",
				o = "find: Nvim options",
				p = "find: Project",
		...
		["+"] = "edit: Increment number under cursor",
		["-"] = "edit: Decrement number under cursor",
		["<C-a>"] = {
