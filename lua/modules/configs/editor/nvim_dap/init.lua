return function()
	...
	require("modules.configs.editor.dap.dap-lldb")
	require("modules.configs.editor.dap.dap-lua")
	require("modules.configs.editor.dap.dap-python")
	require("modules.configs.editor.dap.dap-go")
end
